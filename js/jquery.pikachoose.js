 ...
 */ (function (g) {
	...
	g.jcarousel = function (a, c) {
		...
		!m && false ? (this.buttons(!1, !1), g(window).bind("load.jcarousel", function () {
			e.setup()
		})) : this.setup()
	};
	var f = g.jcarousel;
	...
	$pc.fn.extend({
		...
		finishAnimating: function (data) {
			...
			if (data.clickThrough != "") {
				...
				// this.anchor.attr('id', data.clickThroughTitle);
				this.anchor.attr('title', data.clickThroughTitle);

				// recommend by ChNK 20150402
				if (data.clickThrough === '/recommend/') {
					var _parent = this.anchor.parent();
					_parent.prepend('<a id="linkRecommendJoshi" class="linkRecommend" href="/recommend/#joshi"></a>');
					this.anchor.addClass('linkRecommend');
				} else {
					$('#linkRecommendJoshi, #imgRecommend').remove();
					this.anchor.removeClass('linkRecommend');
				}
			} else {
